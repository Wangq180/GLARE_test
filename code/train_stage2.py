...
def main():
    ...
    parser.add_argument('--opt', type=str, help='Path to option YMAL file.',
                            default='./code/confs/LOL-vq-no-squeeze-with-mean-320-320-large-lr-with-gt.yml' if sys.platform != 'win32' else './code/confs/LOL-vq-no-squeeze-with-mean-320-320-large-lr-with-gt.yml') #  './confs/LOLv2-pc_rebuttal.yml') # 
    ...
    for epoch in range(start_epoch, total_epochs + 1):
        ...
        for _, train_data in enumerate(train_loader):
            ...
            save_ = False
            if current_step >= 32000 and current_step % 50 == 0:
                save_ = True
            if current_step >= 40000 and current_step % 20 == 0:
                save_ = True
            if current_step >= 60000 and current_step % 5 == 0:
                save_ = True
